...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{pics/Backend/Verwendungen/cv-oninit2.png}
...
Auf der Projektseite durchläuft ngOnInit die Liste der gespeicherten GitHub-Repositories und platziert jedes Repo. Die Repositories werden von einer GitHub API geholt und dann in der Datenbank selbst gespeichert. Der Grund dafür ist, dass die GitHub API eine begrenzte Anzahl von Aufrufen pro Stunde hat und es daher sein kann, dass die Repositories zu einem bestimmten Zeitpunkt nicht angezeigt werden können, da die Repositories nicht mehr von der API abgerufen werden können. Aus diesem Grund werden die Repositories nach dem ersten Fetch in der Datenbank gespeichert, so dass sie immer verfügbar sind.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{pics/Backend/Verwendungen/projekte-genRepos.png}
