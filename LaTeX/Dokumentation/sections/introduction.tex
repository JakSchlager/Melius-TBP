...
Die Seite "Kompetenzen" bietet die Möglichkeit, spezifische Fähigkeiten und Kompetenzen hervorzuheben, die für die angestrebte Position von Relevanz sind. Diesbezüglich besteht die Möglichkeit, die ausschlaggebenden Eigenschaften und sozialen Kompetenzen in einer übersichtlichen und klar strukturierten Form darzustellen.

\newpage

Ein besonderes Merkmal von \textit{Melius} ist die Integration und Präsentation aller Daten in einem einheitlichen, ästhetisch ansprechenden Format. Der zeitaufwändige, manuelle Prozess der Zusammenführung verschiedener Dateien und Formate wie PDF-Lebensläufe, Portfolio-Dokumente oder Projektbilder wird somit obsolet.
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.15]{pics/Einfuehrung/Melius_HomePage.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.15]{pics/Einfuehrung/Melius_Lebenslauf.png}
    \caption{Abbildung der Melius Home Page}
    \label{fig:int:cv}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.215]{pics/Einfuehrung/Melius_Gruppen.png}
