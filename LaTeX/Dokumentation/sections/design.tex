...
\subsubsection{Willkommen-Bereichs}
Der Willkommen-Bereichs sowie die Personalisierung sind weitere signifikante Elemente.
Im oberen Bereich der Startseite wird der Benutzer durch einen persönlichen Willkommensgruß empfangen, der seinen Namen prominent hervorhebt.Dieses Detail verleiht der Seite eine persönliche Note und signalisiert, dass die Plattform individuell auf den Nutzer zugeschnitten ist.Ergänzt wird dieser Bereich durch ein kreisförmiges Icon, das als Avatar dient.Der Benutzer soll durch die drei Punkte neben dem Avatar die Möglichkeit haben, ein eigenes Profilbild hinzuzufügen.
...
\subsubsection{Interaktive Boxen}
...
\subsubsection{Allgemeine Informationen des Benutzers}
\subsubsection{Projekte des Benutzers}
\subsubsection{Kompetenzen des Benutzers}
